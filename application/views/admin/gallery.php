                  ...
                  <form action="<?php echo base_url(); ?>admin/addGalleryImages" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        <label>Files</label>
                        <input style="margin-bottom: 10px;" type="file" name="images[]" id="images[]" class="form-control" multiple required>
                        <span class="text-danger">Max file size <strong>1MB</strong>.</span>
                      </div>
